...
#property description "Liquid Forex - EURUSD/GBPUSD Optimized - Max Spread 35, ATR 50, SL 1.2x"
...
input int     Maximum_Spread_Points = 50;       // Maximum Spread (points)
...
input double  ATR_Filter_Min       = 40.0;
