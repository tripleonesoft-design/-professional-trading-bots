...
#property description "Liquid Forex Optimized - Signal Memory / Lookback Windows - Max Spread 60, ATR 50, SL 1.5x"
...
input int     Maximum_Spread_Points = 60;       // Maximum Spread (points)
