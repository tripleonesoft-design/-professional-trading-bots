//+------------------------------------------------------------------+
//|                                   SmartConsensus_Gold.mq5       |
//|                        Gold (XAUUSD) Optimized v1.0              |
//+------------------------------------------------------------------+
...
input int     Maximum_Spread_Points = 2500;      // Maximum Spread (points)
...
const int RSI_ZONE_OVERSOLD            = 38;
const int RSI_ZONE_OVERBOUGHT          = 62;
...
string   GlobalPrefix = "SmartGold_";
const int Magic_Number = 20251203;
...
Print("=======================================================");
    Print("   SmartConsensus Gold v1.0 - Gold Optimized          ");
    Print("=======================================================");
