...
input double  Trailing_Start_ATR    = 1.1;
input double  Trailing_Step_ATR      = 0.55;
...
int OnInit() {
    ...
    if(Point_Value == 0) {
       switch((int)Digits_Value) {
          case 5: Point_Value = 0.00001; break;
          case 4: Point_Value = 0.0001;  break;
          case 3: Point_Value = 0.001;   break;
          case 2: Point_Value = 0.01;    break;
